                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <?php
                                    $customer_feedback = mysqli_num_rows(mysqli_query($conn, "select * from contact"));
                                    ?>
                                    <span class="info-box-text">Feedback</span>
                                    <span class="info-box-number"><?php echo $customer_feedback; ?></span>
                                </div><!-- /.info-box-content -->
                            </div><!-- /.info-box -->
                        </div><!-- /.col -->
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    $new_members_date_range= date_format($added_date, "Y-m-d");                                      
                                      $new_members = mysqli_num_rows(mysqli_query($conn, "select * from customer where reg_date > '$new_members_date_range'"));
