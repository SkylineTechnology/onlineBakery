...
if (isset($_POST["add_charges"])) {
    $ch_id = "CHG-" . date('ism');
    $location = $_POST["charg_location"];
    $chrg_amount = $_POST["chrg_amount"];
    $date = date("Y-m-d H:i:s");


    $insert_charges = mysqli_query($conn, "insert into charges values ('','$location','$chrg_amount')");
    if ($insert_charges) {
        echo "<script>alert('Location and Charges Created Successfully!')</script>";
    } else {
...
if (isset($_GET['id'])) {
    ...
    $delete_customer = mysqli_query($conn, "DELETE FROM charges WHERE  id = '$id'");
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Admin | Create Charges</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Create Charges</h3>
                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <ul class="nav nav-tabs pull-right">                                       
                                         <li ><a href="#sales-chart" data-toggle="tab"> VIEW CHARGES</a></li>
                                        <li class="active" ><a href="#revenue-chart" data-toggle="tab">ADD CHARGES</a></li>
                                    </ul>
                                                    ...
                                                    <div class="row  box-body">
                                                        <div class="col-xs-6"> 
                                                            <div class="form-group has-feedback">
                                                                <input required="" name="charg_location" type="text" class="form-control" placeholder="Enter Location "/>
                                                        ...
                                                        <div class="col-xs-6"> 
                                                            <div class="form-group has-feedback">
                                                                <input required="" name="chrg_amount" type="number" class="form-control" placeholder="Charges Amount "/>
                                                                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                                            </div>
                                                        </div>

                                                        <div class="col-xs-4">
                                                            <button type="submit" name="add_charges" class="btn btn-primary btn-block btn-flat">Add Charges</button>
                                                        </div>
                                                    </div>                                 
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($row = mysqli_fetch_array($result)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>                                                                       
                                                                    <a href='editcharges.php?u=<?php echo base64_encode($row["id"]); ?>'>UPDATE</a>
                                                                </td> 
                                                                <td><a onclick="return confirm('press ok to delete testimony')" href="charges.php?id=<?php echo $row["id"]; ?>">DELETE</a></td>
                                                            </tr>
                                                            <?php
                                                            $a++;
                                                        }
