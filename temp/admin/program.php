...
if (isset($_POST["add"])) {
    $progId = "PROG-" . date('ismymd');
    $topic = addslashes(htmlentities($_POST["topic"]));
    $date = $_POST["date"];
    $time = $_POST["time"];
    ...
    if ($pic_name != "") {
        ...
        if ($img_url != "") {
            $insert_art = mysqli_query($conn, "insert into program values ('$progId','$img_url','$topic','$date','$time','$address','$type')") or die(mysqli_error($conn));
            if ($insert_art) {
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Admin | Create Programe</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Programme Contents</span>
                                    <?php
                                    /** $interval="2 months";
                                      $object=date("Y-m-d");
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Create Programme Content</h3>
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="row  box-body">
                                            <div class="col-xs-12"> 
                                                ...
                                                <div class="form-group has-feedback">
                                                    <input required="" name="topic" type="text" class="form-control" placeholder="Topic "/>
                                            ...
                                            <div class="col-xs-12"> 
                                                ...
                                                <div class="form-group has-feedback">
                                                    <input required="" name="time" type="time" class="form-control" placeholder="Time "/>
                                                    <span class="glyphicon glyphicon-book form-control-feedback"></span>
                                                </div>
                                            </div> 
                                        </div>    
                                        ...
                                        <div class="row  box-body"> 
                                            <div class="col-xs-12"> 
                                                ...
                                                <div class="form-group">
                                                    <textarea class="form-control" required id="editor" name="address" rows="3"  placeholder="Address here">Enter Event</textarea>
                                                </div>
                                            </div>                                            
