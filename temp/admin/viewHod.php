...
if(isset($_GET['del_id'])){
    ...
    $delete_HOD = mysqli_query($conn, "DELETE FROM hod WHERE hid = '$id'");
    
    if ($delete_HOD) {
        header("Location: viewHod.php");
    } else {
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">HOD Table</h3>
                                ...
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $result = mysqli_query($conn, "select * from hod");
                                            $a = 1;
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editHod.php?m=<?php echo base64_encode($row["hid"]); ?>">UPDATE</a>&nbsp;|&nbsp;
                                                        <a href="viewHod.php?del_id=<?php echo $row['hid']; ?>">DELETE</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $a++;
