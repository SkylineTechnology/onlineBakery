...
if (isset($_POST["reg"])) {
    $fname = $_POST["fname"];
    $tmony = $_POST["testimony"];
    $date = date("Y-m-d H:i:s");
    $testid = "TEST-" . date('ismymd');
    $status = "NO";
    $gen = $_POST["gender"];
    //$error_handle = [];
    // Images
    ...
    if ($pic_name != "") {
        ...
        $img_url = upload_screenshot($_FILES['pic']['tmp_name'], $screen_img1_ext, 1);
        if ($img_url != "") {
            $insert_test = mysqli_query($conn, "insert into testimony values ('$testid','$fname','$gen','$tmony','$img_url','$date','$status')");
            if ($insert_test) {
                echo "<script>alert('Testimony Added Successfully!')</script>";
            } else {
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Admin | Testimony Registration</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Testimony Panel</h3>
                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <ul class="nav nav-tabs pull-right">                                       
                                        <li ><a href="#sales-chart" data-toggle="tab"> TESTIMONIES</a></li>
                                         <li class="active" ><a href="#revenue-chart" data-toggle="tab">ADD TESTIMONY</a></li>
                                    </ul>
                                    <div class="tab-content no-padding">
                                            ...
                                            <div class="box-body">
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    <div class="row  box-body">
                                                        <div class="col-xs-6"> 
                                                            <div class="form-group has-feedback">
                                                                <input required="" name="fname" type="text" class="form-control" placeholder="Surname "/>
                                                    ...
                                                    <div class="row  box-body">                                           
                                                        <div class="col-xs-8"> 
                                                            <div class="form-group">
                                                                <textarea name="testimony" class="form-control" rows="3" placeholder="Enter testimony..."></textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row box-body">
                                                        ...
                                                        <div class="col-xs-4">
                                                            <button type="submit" name="reg" class="btn btn-primary btn-block btn-flat">Add testimony</button>
                                                        </div><!-- /.col -->
                                                    </div>
                                                </form> 
                                            </div>
                                        ...
                                        <div class="chart tab-pane " id="sales-chart" style="position: relative; height: 100%;">
                                             <div class="box-body">
                                                    <div class="box-header with-border">
                                                        <h3 class="box-title">Registerd Testimony </h3>
                                                        <div class="box-tools pull-right">
                                                            <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                                            <div class="btn-group">
                                                                <button class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i class="fa fa-wrench"></i></button>
                                                    ...
                                                    <table id="example1" class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $result = mysqli_query($conn, "select * from testimony");
                                                            $posted_testimonies = mysqli_num_rows(mysqli_query($conn, "select * from testimony where status='YES'"));
                                                            $a = 1;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        if ($posted_testimonies < 6) {
                                                                            ?>
                                                                            <?php if ($status == "NO") { ?> 
                                                                                <a href='testimony.php?p=<?php echo base64_encode($test_id); ?>'>POST</a>
                                                                            <?php } else { ?>
                                                                                <a href='testimony.php?h=<?php echo base64_encode($test_id); ?>'>HIDE</a>
                                                                                <?php
                                                                            }
                                                                        } else {
                                                                            ?>
                                                                            <?php if ($status == "NO") { ?>
                                                                                <input style="background-color:red;" class="btn" onclick="return alert('Maximum amount of testimonies posted on home page, please hide other testimonies and try again')" type="submit" readonly="" value="POST">
                                                                            <?php } else { ?>
                                                                                <a href='testimony.php?h=<?php echo base64_encode($test_id); ?>'>HIDE</a>
                                                                                <?php
                                                                            }
                                                                    ...
                                                                    <td><a onclick="return confirm('press ok to delete testimony')" href="testimony.php?d=<?php echo base64_encode($test_id); ?>">DELETE</a></td>
                                                                </tr>
                                                                <?php
                                                                $a++;
                                                            }
