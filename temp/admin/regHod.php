...
if (isset($_POST["reg"])) {
    ...
    $chk_email = mysqli_num_rows(mysqli_query($conn, "select * from hod where username='$username'"));
    if ($chk_email > 0) {
        echo "<script>alert('This email have already been registered!')</script>";
    } else {
        $reg_hod = mysqli_query($conn, "insert into hod values ('$sn','$username','$dept','$fullname','$gender','$phone','$address','$dob','$state','$lga','$reg_date')");

        if ($reg_hod) {
            $get_dept_name= mysqli_fetch_array(mysqli_query($conn,"select dept_name from department where dept_id='$dept'"));
            $dept_name="hod-".$get_dept_name["dept_name"];
            $insert_login = mysqli_query($conn, "insert into login values ('$username','$username','$dept_name','active')");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <?php
                                    $members_num = mysqli_num_rows(mysqli_query($conn, "select * from hod"));
                                    ?>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    $new_members = mysqli_num_rows(mysqli_query($conn, "select * from hod where reg_date > '$new_members_date_range'"));
                                    ?>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">HOD Registration Form</h3>
                                ...
                                <div class="box-body">
                                    <form action="" method="post">
                                        <div class="row  box-body">
                                            <div class="col-xs-6"> 
                                                <div class="form-group has-feedback">
                                                    <input required="" name="username" type="email" class="form-control" placeholder="Email "/>
                                        ...
                                        <div class="row  box-body">
                                            ...
                                            <div class="col-xs-6"> 
                                                <div class="form-group has-feedback">
                                                    <input required="" name="dob" type="date" class="form-control" placeholder="Date of Birth"/>
                                                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                                </div>
                                            </div>
                                            <div class="col-xs-6"> 
                                                <div class="form-group has-feedback">
                                                    <textarea required="" name="address" type="text" class="form-control" rows="4"placeholder="Address "></textarea>
                                                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                                </div>   
                                            </div>
                                        ...
                                        <div class="row box-body">
                                            ...
                                            <div class="col-xs-4">
                                                <button type="submit" name="reg" class="btn btn-primary btn-block btn-flat" style=" width: 100% !important;">Register</button>
                                            </div><!-- /.col -->
                                        </div>
                                    </form>     
                                </div>
